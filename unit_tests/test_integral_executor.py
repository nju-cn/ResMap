...
def _run_jobs(dnn_loader: Callable[[], Dict[str, Any]], wk2jobs: List[IntegralJob]):
    ...
    executor = IntegralExecutor(dnn_loader)
    ex_out = {}
...
def test_alexnet():
    ...
    _run_jobs(prepare_alexnet, wk2jobs)
...
def test_vgg19():
    ...
    _run_jobs(prepare_vgg19, wk2jobs)
...
def test_googlenet():
    ...
    _run_jobs(prepare_googlenet, wk2jobs)
...
def test_resnet50():
    ...
    _run_jobs(prepare_resnet50, wk2jobs)
