...
def test_split_chain():
    assert Scheduler.split_chain([2, 1, 3], [1, 2]) == [0, 2]
    assert Scheduler.split_chain([2, 1, 1, 3, 4], [1, 2]) == [2, 4]
    assert Scheduler.split_chain([2, 1, 1, 3, 4], [1, 2, .1]) == [2, 4, 4]
    assert Scheduler.split_chain([2, 1, 1, 3, 4], [.1, 1, 2]) == [-1, 2, 4]
    ...
    assert Scheduler.split_chain(ax_pc, [1, 1, 1]) == [1, 5, 12]
