...
def show_ifr_records(ifr_records: List[IFRRecord], trds: List[str], xlim: int = None):
    ...
    plt.quiver(7.8, 0.08, 1, 0, color='navy', scale=20, width=0.005)
    plt.text(8.8, 0.2, 'En. & Tr.', fontsize=13, )

    plt.quiver(7.8, 1., 1, 0, color='navy', scale=20, width=0.005)
    plt.text(8.8, 1.2, 'De.', fontsize=13, )

    plt.quiver(11.8, 1.92, 1, 0, color='navy', scale=20, width=0.005)
    plt.text(12.8, 2.1, 'In.', fontsize=13, )

    plt.quiver(11.8, 2.92, 1, 0, color='navy', scale=20, width=0.005)
    plt.text(12.8, 3.1, 'En. & Tr.', fontsize=13, )

    plt.quiver(11.8, 3.92, 1, 0, color='navy', scale=20, width=0.005)
    plt.text(12.8, 4.1, 'De.', fontsize=13, )

    plt.quiver(11.5, 4.92, 1, 0, color='navy', scale=20, width=0.005)
    plt.text(12.5, 5.1, 'In.', fontsize=13, )

    plt.quiver(11.5, 5.92, 1, 0, color='navy', scale=20, width=0.005)
    plt.text(12.5, 6.1, 'Tr.', fontsize=13, )
    plt.tight_layout()
    plt.show()
...
if __name__ == '__main__':
    ...
    TCZIP = 'ax_parking/my.zip'  # 从zip文件中读取tc文件
