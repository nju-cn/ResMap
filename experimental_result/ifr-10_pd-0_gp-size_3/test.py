...
def show_ifr_records(ifr_records: List[IFRRecord], trds: List[str], xlim: int = None):
    ...
    trd2y = {t: i for i, t in enumerate(trds[:7])}
    ...
    plt.text(14.8, 0.2, 'En. & Tr.', fontsize=13, )

    plt.quiver(13.8, 1., 1, 0, color='navy', scale=20, width=0.005)
    plt.text(14.8, 1.2, 'De.', fontsize=13, )

    plt.quiver(14.8, 1.92, 1, 0, color='navy', scale=20, width=0.005)
    plt.text(15.8, 2.1, 'In.', fontsize=13, )

    plt.quiver(15.8, 2.92, 1, 0, color='navy', scale=20, width=0.005)
    plt.text(16.8, 3.1, 'En. & Tr.', fontsize=13, )

    plt.quiver(15.8, 3.92, 1, 0, color='navy', scale=20, width=0.005)
    plt.text(16.8, 4.1, 'De.', fontsize=13, )

    plt.quiver(16.5, 4.92, 1, 0, color='navy', scale=20, width=0.005)
    plt.text(17.5, 5.1, 'In.', fontsize=13, )

    # plt.quiver(16.5, 5.92, 1, 0, color='navy', scale=20, width=0.005)
    # plt.text(17.5, 6.1, 'Tr.', fontsize=13, )
    plt.tight_layout()
...
if __name__ == '__main__':
    ...
    TCZIP = 'ax_road/lb.zip'  # 从zip文件中读取tc文件
