...
if __name__ == '__main__':
    ...
    #cbar.ax.tick_params(labelsize=13)
    #cbar.set_label('Number of Frames', fontproperties=lg)
    plt.text(8, 0.23, r'59.2%', ha='center', va='bottom', fontsize=10)
    ...
    cbar.ax.tick_params(labelsize=13)
    cbar.set_label('Number of Frames', fontproperties=lg)
    plt.text(23, 0.23, r'64.62%', ha='center', va='bottom', fontsize=10)
    ...
    plt.text(25, 0.09, r'30.5%', ha='center', va='bottom', fontsize=10)
    ...
    cbar.ax.tick_params(labelsize=13)
    cbar.set_label('Number of Frames', fontproperties=lg)
    plt.text(25, 0.09, r'32.54%', ha='center', va='bottom', fontsize=10)
    plt.quiver(20, 0.5, 0, -1, color='b', scale=3, width=0.02)
    plt.show()
