...
if __name__ == '__main__':
    ...
    # TODO: 使用动画展示迭代过程
    # 第0帧调度
    opt_lbsz = Scheduler.dif2lbsz(ipt0, s_dag, predictors)
    wk_elys = Scheduler.optimize_chain(lb_wk_layers, [[] for _ in range(len(wk_cap))], wk_cap, wk_bwth,
    ...
    Scheduler.optimize_chain(lb_wk_layers, pre_wk_ilys, wk_cap, wk_bwth, opt_lbsz, dif_lbsz, ly_comp, 5, True)
